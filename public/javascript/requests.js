function display(el){
    ...
    document.getElementById('seriously3').style.display = 'block';   
    document.getElementById('seriously3').setAttribute("data-user-id",el.parentElement.dataset.userId)   
    document.getElementById('seriously3').setAttribute("data-topic-id",el.parentElement.dataset.topicId)   
}
function hide(){
    document.getElementById("seriously3").style.display = 'none';
    var btns = document.getElementsByClassName('user-options');
...
sendRequestFromJS("DELETE",`/delete-user/${uId}`);
